...
{ /* Main */
    (function init(jQuery, window, document, undefined) {
        ...
        jQuery.fn.flipBook.options = {
            ...
            cartTotal: 0,
            cartEmptyIcon: false,
            cartCheckoutText: "Finalizar Pedido",
            cartCheckout: false,
            ...
            assets: {
                preloader: "https://static.2bebot.com.br/componentes/flipbook/deploy/images/preloader.jpg",
                overlay: "https://static.2bebot.com.br/componentes/flipbook/deploy/images/overlay.png",
                flipMp3: "https://static.2bebot.com.br/componentes/flipbook/deploy/mp3/turnPage.mp3",
                spinner: "https://static.2bebot.com.br/componentes/flipbook/deploy/images/spinner.gif"
            },
            ...
            sideBtnTextShadow: '',
            sideBtnBorder: '',
            sideBtnColorHover: "#00000066",
            sideBtnBackgroundHover: 'none',
            ...
            strings: {
                ...
                search: "Procurar",
                findInDocument: "Pesquisar no catálogo",
                pagesFoundContaining: "páginas encontradas contendo",

                thumbnails: "Thumbnails",
                tableOfContent: "Categoria de Produtos",
                cart: "Minha Seleção de Produtos",
                share: "Compartilhar",
                sideMenu: "",
                cookies: "PRIVACIDADE & COOKIES",
                cookiesConfig: "CONFIGURAÇÕES",

                liveChatName: "Atendente Virtual",

                pressEscToClose:"Pressione ESC para sair",
        ...
        FLIPBOOK.Main = function(options, elem) {
            ...
            this.cookiesShowing = false
            this.modalIndisponivelShowing = false
            this.modalCalendarShowing = false
            this.modalFormularioShowing = false
            this.modalCheckoutChatbotShowing = false
            this.modalSaldoDisponivelShowing = false
            this.modalSaldoIndisponivelShowing = false
            this.liveChatShowing = false
            this.menuShowing = true
            this.cookiesConfigShowing = false
           ...
           var layouts = {
            ...
            "3":{ // top 
                ...
                menu2Padding:5,
                btnMargin:0,
                btnSideMenu: {vAlign:'top', hAlign:'left',order:-1},
                currentPage:{vAlign:'top', hAlign:'center'},
                btnPrint:{vAlign:'top',hAlign:'right'},
                btnDownloadPdf:{vAlign:'top',hAlign:'left'},
                btnDownloadPages:{vAlign:'top',hAlign:'right'},
                btnThumbs:{vAlign:'top',hAlign:'left'},
                btnToc:{vAlign:'top',hAlign:'center'},
                btnLiveChat:{vAlign:'top',hAlign:'left'},
                btnCart:{vAlign:'top',hAlign:'right',order:-1},
                btnBookmark:{vAlign:'top',hAlign:'left'},
                btnSearch:{vAlign:'top',hAlign:'right'},
                btnSelect:{vAlign:'top',hAlign:'right'},
                btnShare:{vAlign:'top',hAlign:'center',order:-1},
            ...
            o.sideMenuPosition = o.rightToLeft ? 'left' : 'right'
            ...
            if(o.chatbot){
                this.chatLayer = jQuery(document.createElement('div'))
                    .addClass('flipbook-chat')
                    .appendTo(self.wrapper)
                this.chatHeader = jQuery(document.createElement('div'))
                    .addClass('flipbook-chatheader')
                    .appendTo(self.chatLayer)
                this.chatBot = jQuery(document.createElement('div'))
                    .addClass('flipbook-chatbot')
                    .appendTo(self.chatLayer)
            ...
            if (o.cartProducts) {
                $(document).on('click','.flipbook-cart-btn',function(){
                    var el = $(this);
                    var selectedProduct = el.data("product");
                    var product = $.map( self.options.cartProducts, function( a, index ) {
                        if(a.sku == selectedProduct){
                            return a;
                        }
                    });
                    product = product[0];
                    console.log(product)
                    if(product.status == "0"){
                        self.toggleModalIndisponivel();
                        return false;
                    }
                    if(product.complementos){
                        if(product.complementos.length > 0){
                            self.createModalComplemento(product, el);
                            return false;
                        }
                    }
                    self.dragToCart(el);
                    self.cartAdd(product)
                });
            }

            $(document).on('click','.flipbook-add-form',function(){
                var el = $(this);
                var _dtForm = el.data("form");
                self.toggleModalFormulario(_dtForm);
            });

            $(document).on('click','.flipbook-add-internal-link',function(e){
                e.preventDefault();
                var el = $(this);
                var _dtPage = parseInt(el.attr("data-page"));
                self.goToPage(_dtPage);
            });
            $(document).on('click','.flipbook-add-blurred',function(e){
                e.preventDefault();
                var el = $(this);
                el.remove();
            });
        ...
        FLIPBOOK.Main.prototype = {
            ...
            initChat: function() {
                ...
                if (!FLIPBOOK.scriptsAdded[FLIPBOOK.jQueryInputMask]) {
                    this.loadScript(FLIPBOOK.jQueryInputMask, function() {
                        this.initChat()
                    })
                    return;
                }
                if (!FLIPBOOK.scriptsAdded[FLIPBOOK.socketIOSrc]) {
                    this.loadScript(FLIPBOOK.socketIOSrc, function() {
                        this.initChat()
                    })
                    return;
                }
                if (!FLIPBOOK.scriptsAdded[FLIPBOOK.landbotSrc]) {
                    this.loadScript(FLIPBOOK.landbotSrc, function() {
                        this.initChat()
                    })
                    return;
                }
                ...
                this.chatbotContainer = new Landbot.Container({
                    container: '.flipbook-chatbot',
                    configUrl: 'https://chats.landbot.io/v3/' + o.chatbot + '/index.json',
                    customData: o.chatData
                });
            },
            ...
            endChat: function(cpf, codBarras, whatsapp, saldo, id) {
                //console.log(cpf, codBarras, whatsapp, saldo, id)
                this.options.cartCredits = parseInt(saldo);
                this.options.carneCpf = cpf;
                this.options.carneSessao = id;
                this.options.carneCod = codBarras;
                this.options.carneWhatsApp = whatsapp;
                var o = this.options;
                
                this.options.ws.emit('bau-autenticado', { 
                    "cpf": cpf,
                    "codBarras": codBarras,
                    "whatsapp": whatsapp,
                    "saldo": saldo,
            ...
            initTour: function(opt) {
                var o = this.options;

                if (o.refusetour && opt == "Agora não.")
                    o.refusetour.call(this)
                if (o.inittour && opt == "COMO USAR")
                    o.inittour.call(this)
            },
            ...
            updateCurrentPage: function() {
                ...
                if (s != this.currentPageValue){
                    ...
                    this.currentPageInput.width('100%')
                    ...
                    if(_paq){
                        _paq.push(['trackEvent', 'Mostrar Página', 'Página: ' + this.currentPageValue]);
                    }
            ...
            initPdf: function() {
                ...
                if (!FLIPBOOK.scriptsAdded[FLIPBOOK.socketIOSrc]) {
                    self.loadScript(FLIPBOOK.socketIOSrc, function() {
                        self.initPdf()
                    })
                    return;
                }
                if (!FLIPBOOK.scriptsAdded[FLIPBOOK.jQueryModalSrc]) {
                    jQuery('head').append('<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery-modal/0.9.1/jquery.modal.min.css">')
                    self.loadScript(FLIPBOOK.jQueryModalSrc, function() {
                        self.initPdf()
                    })
                    return;
                }
                if(this.options.cartForms){
                    
                    if (!FLIPBOOK.scriptsAdded[FLIPBOOK.dateTimePickerSrc]) {
                        jQuery('head').append('<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/css/bootstrap-datepicker.standalone.min.css" integrity="sha512-TQQ3J4WkE/rwojNFo6OJdyu6G8Xe9z8rMrlF9y7xpFbQfW5g8aSWcygCQ4vqRiJqFsDsE1T6MoAOMJkFXlrI9A==" crossorigin="anonymous" />')
                        self.loadScript(FLIPBOOK.dateTimePickerSrc, function() {
                            self.initPdf()
                        })
                        return;
                    }
                    if (!FLIPBOOK.scriptsAdded[FLIPBOOK.dateTimePickerLocaleSrc]) {
                        self.loadScript(FLIPBOOK.dateTimePickerLocaleSrc, function() {
                            self.initPdf()
                        })
                        return;
                    }
                    if (!FLIPBOOK.scriptsAdded[FLIPBOOK.momentSrc]) {
                        self.loadScript(FLIPBOOK.momentSrc, function() {
                            self.initPdf()
                        })
                        return;
                    }
                    if (!FLIPBOOK.scriptsAdded[FLIPBOOK.momentLocaleSrc]) {
                        self.loadScript(FLIPBOOK.momentLocaleSrc, function() {
                            self.initPdf()
                        })
                        return;
                    }
                    if (!FLIPBOOK.scriptsAdded[FLIPBOOK.TimePickiSrc]) {
                        jQuery('head').append('<link rel="stylesheet" href="https://static.2bebot.com.br/componentes/TimePicki/timepicki.css" />')
                        self.loadScript(FLIPBOOK.TimePickiSrc, function() {
                            self.initPdf()
                        })
                        return;
                    }
                ...
                if (!FLIPBOOK.scriptsAdded[FLIPBOOK.jQueryInputMask]) {
                    self.loadScript(FLIPBOOK.jQueryInputMask, function() {
                        self.initPdf()
                    })
                    return;
                }
                ...
                this.options.ws = io.connect('https://ws.2bebot.com.br/bau');
                this.options.ws.on('connect', function() {
                    $.get( "https://api.ipregistry.co/?pretty=false&key=fuefc0fhjq3kjh", function( data ) {
                        var _setUsuario = {
                            "ua": data,
                            "origem": self.options.origem
                        }
                        if(Object.keys(self.options.chatData).length > 0){
                            _setUsuario["chatData"] = self.options.chatData
                        }    
                        self.options.ws.emit('usuario-ua', _setUsuario);
                    });
                });
                ...
                if(this.options.password){
                    var pass = prompt("Por favor insira a senha", "");
                  if (pass != null) {
            ...
            createBook: function() {
                ...
                this.sideMenuCreated = false
                this.liveChatCreated = false
                this.cookiesCreated = false
                this.modalIndisponivelCreated = false
                this.modalCalendarCreated = false
                this.modalFormularioCreated = false
                this.modalCheckoutChatbotCreated = false
                this.modalSaldoIndisponivelCreated = false
                this.modalSaldoDisponivelCreated = false
                this.modalComplementoCreated = false
                this.cookiesConfigCreated = false
            ...
            addPageItems:function(){
                ...
                var _r = this.options.firstPage.ratio *1000
                var _ow = this.options.firstPage.width
                var _oh = this.options.firstPage.height
                    ...
                    if(page.items){
                        ...
                        for(var key2 in page.items){
                            ...
                            switch(item.type){
                                ...
                                case "addForm":
                                    el = jQuery('<a>')
                                    .addClass('flipbook-add-cart')
                                    .addClass('flipbook-add-form')
                                    .width( ((item.width * _r) / _ow) + 'px')
                                    .height( ((item.height * 1000) / _oh) + 'px')
                                    .css({
                                        'top': ((item.y * 1000) / _oh) + 'px',
                                        'left': ((item.x * _r) / _ow) + 'px',
                                        'background' : item.bgColor,
                                        'color': item.iconColor,
                                        'border-radius': item.borderRadius,
                                        'line-height': (((item.height * 1000) / _oh) + 5) + 'px',
                                        'font-size': item.fontSize ? item.fontSize : ((item.height * 1000) / _oh) / 2  
                                    })
                                    .attr('data-form', item.form)
                                    .attr('href', '#').attr('target', '_self')

                                    if(item.customIcon){
                                        el.html('<i class="' + item.customIcon + '"></i>');
                                    } else {
                                        el.html('<i class="fas fa-pencil-alt"></i>');
                                    }
                                    
                                    if(item.effectShaking)
                                        el.addClass('btn-shaking');
                                    
                                    if(item.effectSlideDown)
                                        el.addClass('btn-slide-down');
                                ...
                                case "addInternalLink":
                                    el = jQuery('<a>')
                                    .addClass('flipbook-add-cart')
                                    .addClass('flipbook-add-internal-link')
                                    .width( ((item.width * _r) / _ow) + 'px')
                                    .height( ((item.height * 1000) / _oh) + 'px')
                                    .css({
                                        'top': ((item.y * 1000) / _oh) + 'px',
                                ...
                                case "addExternalLink":
                                    el = jQuery('<a>')
                                    .addClass('flipbook-add-cart')
                                    .addClass('flipbook-add-external-link')
                                    .width( ((item.width * _r) / _ow) + 'px')
                                    .height( ((item.height * 1000) / _oh) + 'px')
                                    .css({
                                        'top': ((item.y * 1000) / _oh) + 'px',
                                ...
                                case "addToCart":
                                    ...
                                    .attr('data-product', item.product)
                                    .attr('href', '#').attr('target', '_self')
                                    .attr('title', 'Adicionar ao Carrinho')
                                ...
                                case "carrinhoJequiti":
                                    el = jQuery('<a>')
                                    .addClass('flipbook-jqt-cart')
                                    .addClass('flipbook-cart-btn')
                                    .width( ((item.width * _r) / _ow) + 'px')
                                    .height( ((item.height * 1000) / _oh) + 'px')
                                    .css({
                                    ...
                                    .attr('data-product', item.product)
                                    .attr('href', '#').attr('target', '_self')
                                    //.attr('title', this.options.cartProducts[item.product]["titulo"])
                                    ...
                                    if(item.effectIndicate)
                                        el.addClass('flipbook-jqt-cart-indicate');
            ...
            createIcon:function(btn, alt, transparent, skin=true){
            ...
            createButton: function(btn) {
                ...
                var btnWidth = (btn.size || o.btnSize) + 18
                ...
                $btn.attr('data-name', btn.name)
                    ...
                    .attr('role', 'tooltip')
                    .attr('data-microtip-position', ( (btn.vAlign == 'top') ? 'bottom' : 'top' ))
                    .addClass(cssClass)
                    .css('order', btn.order)
            ...
            createLogo: function() {
                ...
                var $logo = jQuery('<img>')
                    ...
                    .prependTo(".flipbook-menuTop .flipbook-menu-center")
            ...
            createMenuHeader: function(elem, title, onClose, skin=true) {

                var self = this

                var header = jQuery("<div>")
                    .addClass("flipbook-menu-header skin-color flipbook-font")
                    .appendTo(elem);
                ...
                var $icon = this.createIcon(this.options.btnClose, null, true, skin)
                    .appendTo(btnClose)
                    // .attr('aria-hidden', 'true')
                    // .addClass('fa fa-times flipbook-btn-close-icon skin-color')
                if(!skin){
                    header.removeClass('skin-color');
                    title.removeClass('skin-color');
                }
            ...
            createCart: function() {
                ...
                var self = this,
                credits = this.options.cartCredits;

                this.cartHolder = jQuery('<div>')
                    .addClass('flipbook-cartHolder flipbook-side-menu')
                    .appendTo(this.wrapper)
                    .css(this.options.sideMenuPosition, '0')
                    .hide()

                if(self.options.carneCod || self.options.chatData.cod_barras_selecionado){
                    self.createMenuHeader(this.cartHolder, "MEU RESGATE", this.toggleCart, false)
                    _codCompleto = self.options.carneCod ? self.options.carneCod : self.options.chatData.cod_barras_selecionado;
                    _codArray = _codCompleto.split("")
                    _serie = _codArray.slice(0, 3).join("") + "-" + _codArray.slice(3, 4).join("") ;
                    _num = _codArray.slice(4, 10).join("")
                    this.carneCodCart = jQuery('<p>')
                                    .css('font-size', '0.8rem')
                                    .css('margin', '0')
                                    .text('Série: ' + _serie + ' | Número: ' + _num)
                                    .insertAfter( this.cartHolder.find(".flipbook-menu-title") )
                }else{
                    self.createMenuHeader(this.cartHolder, this.strings.cart, this.toggleCart, false)
                }                

                jQuery('<div>')
                    .addClass('separador')
                    .css("border-top", "2px solid #bbb")
                    .css("margin-top", "0")
                    .appendTo(this.cartHolder)

                this.cart = jQuery('<div>')
                    .addClass('flipbook-cart')
                    .appendTo(this.cartHolder)

                this.cartScroller = jQuery('<div>')
                    .addClass('flipbook-cart-scroller')
                    .appendTo(this.cart);

                this.cartFooter = jQuery('<div>')
                    .addClass('flipbook-cart-footer')
                    .appendTo(this.cart);

                this.cartVal = jQuery('<div>')
                    .addClass('flipbook-cart-footer-values')
                    .appendTo(this.cartFooter);

                this.cartTotalHolder = jQuery('<span>')
                .addClass('flipbook-cart-footer-title')
                .text("Preço Total")
                .appendTo(this.cartVal);

                this.cartTotalQnt = jQuery('<span>')
                .addClass('flipbook-cart-footer-title')
                .addClass('flipbook-cart-footer-title-sm')
                .css("padding-left", "5px")
                .text("(0 itens)")
                .appendTo(this.cartVal);

                this.cartTotalValue = jQuery('<span>')
                .addClass('flipbook-cart-footer-value')
                .text("R$ 0,00")
                .appendTo(this.cartVal);
                ...
                if(credits && credits > 0){
                    ...
                    this.cartCreditsHolder = jQuery('<span>')
                        .addClass('flipbook-cart-footer-title')
                        .addClass('flipbook-cart-footer-title-sm')
                        .text("Saldo restante")
                        .appendTo(this.cartVal);

                    this.cartCreditsValue = jQuery('<span>')
                        .addClass('flipbook-cart-footer-value')
                        .addClass('flipbook-cart-footer-value-sm')
                ...
                this.cartCheckoutButton = jQuery('<div>')
                .addClass('flipbook-cart-button')
                .addClass('flipbook-cart-checkout')
                .appendTo(this.cartFooter);
                this.cartCheckoutValid = jQuery('<span>')
                    .addClass('finalizar-pedido')
                    .text(this.options.cartCheckoutText)
                    .appendTo(this.cartCheckoutButton);

                if(this.options.cartCheckout){
                    this.cartCheckoutButton.bind('tap click', function(e) {
                        
                        var _wsid = self.options.ws.id.split("#")[1]
                        if (self.options.cartItens && self.options.cartItens.length > 0) {
                            
                            if(self.options.cartCheckout == "sacbau"){
                                _total = self.options.cartTotal;
                                _saldo = self.options.cartCredits;
                                _diferenca = _saldo - _total;
                                if(_diferenca > 0){
                                    // Total do carrinho é menor do que o saldo
                                    self.toggleModalSaldoDisponivel();
                                }else if(_diferenca < 0){
                                    // Total do carrinho é maior do que o saldo
                                    self.toggleModalSaldoIndisponivel();
                                }else{
                                    // Total do carrinho é o mesmo do saldo
                                }

                                // Envia payload carrinho
                                /*var _payload = {
                                    products: [],
                                    user_cpf: self.options.carneCpf,
                                    subtotal: 0,
                                    codigoBarras: self.options.carneCod
                                }
                                for (item in self.options.cartItens) {
                                    _item = self.options.cartItens[item]
                                    _produto = $.map( self.options.cartProducts, function( a, index ) {
                                        if(a.sku == item){
                                            return a;
                                        }
                                    });
                                    _produto = _produto[0];
                                    _amount = parseInt(_item["amount"]);
                                    _valor = _item["price"] * _amount;
                                    _payload.products.push({
                                        productCode: _item["sku"],
                                        quantity: _amount
                                    });
                                    _payload.subtotal += _valor;
                                }
                                
                                $.post( "https://sgi.2bebot.com.br/order/create", _payload, function( data ) {
                                    console.log( data );
                                }, "json");*/

                            }else{
                                window.onbeforeunload = false;
                                if(self.options.cartCheckout === 1){
                                    window.location.href = "../checkout/" + _wsid;
                                }else{
                                    self.toggleModalCheckoutChatbot();
                                }
                            }
                        }
                    })
                }else{
                    if (self.options.oncartcheckout){
                        this.cartCheckoutButton.bind('tap click', function(e) {
                            self.options.oncartcheckout.call(this, self.options.cartItens)
                        });
                    }
                }
                

                this.cartCheckoutInvalidTitle = jQuery('<p>')
                    .addClass('saldo-insuficiente')
                    .html("Saldo Insuficiente!")
                    .appendTo(this.cartCheckoutButton);
                this.cartCheckoutInvalidDesc = jQuery('<p>')
                    .addClass('saldo-insuficiente')
                    .addClass('flipbook-cartItem-desc')
                    .html("Remova produtos do carrinho para continuar.")
                    .appendTo(this.cartCheckoutButton);
            ...
            updateComplemento: function(produto) {
                var self = this;
                var complementos = {
                    "valido": true,
                    "complementos": [],
                ...
                $.each(produto.complementos, function (i, item) {
                    
                    if(item.max == 1){
                        _radio = $("input[name=" + i + "]:checked").val();
                        if(_radio || _radio === "0"){
                            _valor = item.opcoes[parseInt(_radio)].valor;
                            if(_valor){
                                _valor = parseFloat(_valor)
                                complementos.total += _valor
                            } 
                            complementos.complementos.push({
                                "amount": 1,
                                "valor": _valor,
                                "titulo": item.opcoes[parseInt(_radio)].titulo
                            })
                        }else if(item.status == 1){
                            complementos.valido = false
                        }
                    }else{
                        _complementos = 0;
                        $.each(item.opcoes, function (_i, _opcao) {
                            _input = $("input[data-complemento=" + i + "][data-opcao=" + _i + "]");
                            _qnt = parseInt(_input.val());
                            _complementos += _qnt;
                            _valor = parseFloat(_opcao.valor)
                            if(_valor && _qnt > 0){
                                complementos.total += (_valor * _qnt);
                            }
                            ...
                            if(_qnt > 0){
                                complementos.complementos.push({
                                    "amount": _qnt,
                                    "valor": (_valor * _qnt),
                                    "titulo": _opcao.titulo
                                })
                            }
                        });
                        if(item.status == 1 && _complementos < item.min){
                            complementos.valido = false
                        }
                    }
                });

                self.complementoAdicionarTotal.html(new Intl.NumberFormat('pt-BR', {
                        style: 'currency', 
                        currency: 'BRL' 
                }).format(complementos.total))
                .attr('data-valor', complementos.total);
                return complementos
            },
            ...
            updateCart: function() {
                var self = this,
                cart = self.btnCart,
                cartArray = this.options.cartItens,
                cartProducts = this.options.cartProducts,
                credits = this.options.cartCredits;

                _cartTotal = 0;
                _cartAmount = 0;

                this.cartScroller.html("");
                
                this.options.ws.emit('bau-carrinho', { 
                    "session": self.options.carneSessao,
                    "cartItens": cartArray,
                    "origem": self.options.origem
                });
                
                if (cartArray && cartArray.filter(Boolean).length > 0) {
                    window.onbeforeunload = function(e) {
                            return false;
                    };
                    this.cartCheckoutButton.removeClass("flipbook-cart-checkout-disabled");

                    for (item in cartArray) {
                        _item = cartArray[item]
                        if(_item){
                        _produto = $.map( cartProducts, function( a, index ) {
                            if(a.sku == item){
                                return a;
                            }
                        });
                        ...
                        _valorStr = new Intl.NumberFormat('pt-BR', {
                             style: 'currency', 
                             currency: 'BRL' 
                        }).format(_valor);
                        
                        cartItem = jQuery(document.createElement('div'))
                            .attr('class', 'flipbook-cartItem')
                            .attr('data-produto', item)
                            .attr('data-quantidade', _amount)
                            .appendTo(this.cartScroller);

                        if (_item.img){
                            jQuery(document.createElement('div'))
                                .attr('class', 'flipbook-cartItem-img')
                                .html('<img src="' + _item.img + '">')
                                .appendTo(cartItem);
                        }
                        itemContent = jQuery(document.createElement('div'))
                                .attr('class', 'flipbook-cartItem-content')
                                .appendTo(cartItem);
                        
                        itemTitle = jQuery(document.createElement('p'))
                                .attr('class', 'flipbook-cartItem-title')
                                .text(_item.title)
                                .appendTo(itemContent);
                        itemDesc = jQuery(document.createElement('p'))
                                .attr('class', 'flipbook-cartItem-desc')
                                .text(_item.description)
                                .appendTo(itemContent);
                        if(_item.complementos){
                            $.each(_item.complementos, function (idx, selecionado) {
                                itemDesc.text(itemDesc.text() + " + " + selecionado.amount + "x " + selecionado.titulo);
                            });
                        }

                        itemCtrl = jQuery(document.createElement('div'))
                                .attr('class', 'flipbook-cartItem-ctrl')
                                .appendTo(itemContent);

                        itemVal = jQuery(document.createElement('span'))
                                .attr('class', 'flipbook-cartItem-val')
                                .text(new Intl.NumberFormat('pt-BR', {
                                                style: 'currency', 
                                                currency: 'BRL' 
                                        }).format(_item["price"]))
                        ...
                        itemUn = jQuery(document.createElement('span'))
                                .attr('class', 'flipbook-cartItem-desc')
                                .text(' /un')
                                .appendTo(itemVal);
                        
                        itemInputHolder = jQuery(document.createElement('div'))
                                .attr('class', 'flipbook-cartItem-input-holder')
                                .appendTo(itemCtrl);

                        itemAmount = jQuery(document.createElement('input'))
                                .attr('class', 'flipbook-cartItem-amount')
                                .attr('type', 'number')
                                .attr('placeholder', '0')
                                .attr('min', '0')
                                .attr('max', '99')
                                ...
                                .attr('data-produto', item)
                                .val(_amount)
                                .appendTo(itemInputHolder);

                        itemAmount.inputSpinner();
                        itemAmount.on("input", function (event) {
                            _input = $(this);
                            _alvo = _input.data("produto");
                            _qnt = _input.val();
                            if(_qnt == 0){
                                delete cartArray[parseInt(_alvo)];
                            }else{
                                cartArray[parseInt(_alvo)]["amount"] = parseInt(_qnt);
                            }
                            self.updateCart();
                        })

                        var itemRemove = jQuery(document.createElement('p'))
                                .attr('class', 'flipbook-cartItem-remove')
                                .html('<i class="fa fa-trash-alt"></i> Remover')
                                .attr('data-produto', item)
                                .appendTo(itemInputHolder)
                                .bind('tap click', function(e) {
                                    _bt = $(this);
                                    _alvo = _bt.data("produto");
                                    delete cartArray[parseInt(_alvo)];
                                    self.updateCart();
                                });
                                
                        jQuery(document.createElement('div'))
                            .attr('class', 'separador')
                            .appendTo(this.cartScroller);
                        }
                    }
                    cart.find(".flipbook-menu-btn").html("<span class='flipbook-btncart-amount flipbook-color-dark'>" + _cartAmount + "</span>")

                } else {
                    // Carrinho Vazio
                    window.onbeforeunload = false;
                    cart.find(".flipbook-menu-btn").html("")
                    if(this.options.cartEmptyIcon){
                        jQuery(document.createElement('div'))
                            .attr('class', 'flipbook-cartEmpty')
                            .html('<i class="flipbook-empty-icon ' 
                                    + this.options.cartEmptyIcon + 
                                    '" style="color: ' 
                                    + this.options.skinBackground + 
                                    '"></i><p class="m-0 texto-destaque">Carrinho Vazio</p><p class="m-0 texto-corrido">Encontre produtos no catálogo para adiciona-los aqui.</p>')
                            .appendTo(this.cartScroller)
                    }else{
                        jQuery(document.createElement('div'))
                        .attr('class', 'flipbook-cartEmpty')
                        .html('<img src="https://static.2bebot.com.br/media/sacola.svg"><p class="m-0 texto-destaque">Carrinho Vazio</p><p class="m-0 texto-corrido">Encontre produtos no catálogo para adiciona-los aqui.</p>')
                        .appendTo(this.cartScroller)
                    }
                    
                    this.cartCheckoutButton.addClass("flipbook-cart-checkout-disabled");
                }

                this.cartTotalValue.text(new Intl.NumberFormat('pt-BR', {
                        style: 'currency', 
                        currency: 'BRL' 
                }).format(_cartTotal));
                this.options.cartTotal = _cartTotal

                this.cartTotalQnt.html(
                    "(" + _cartAmount + " "  
                        + (_cartAmount == 1 ? "item" : "itens") + 
                    ")");
                
                

                if(credits && credits > 0){
                    _after = credits - _cartTotal;
                    /*if(_after < 0){
                        this.cartCheckoutInvalidTitle.show();
                        this.cartCheckoutInvalidDesc.show();
                        this.cartCheckoutValid.hide();
                        this.cartCheckoutButton.addClass("flipbook-cart-checkout-disabled");
                        this.cartCreditsHolder.addClass("flipbook-cart-negative");
                        this.cartCreditsValue.addClass("flipbook-cart-negative");
                    }else{
                        this.cartCheckoutInvalidTitle.hide();
                        this.cartCheckoutInvalidDesc.hide();
                        this.cartCheckoutValid.show();
                        
                        if (cartArray && cartArray.length > 0) this.cartCheckoutButton.removeClass('flipbook-cart-checkout-disabled');
                        this.cartCreditsHolder.removeClass("flipbook-cart-negative");
                        this.cartCreditsValue.removeClass("flipbook-cart-negative");
                    }*/

                    this.cartCreditsValue.text(new Intl.NumberFormat('pt-BR', {
                                        style: 'currency', 
                                        currency: 'BRL' 
                                }).format(_after));
                }
            ...
            createSideMenu: function() {
                ...
                this.sideMenuHolder = jQuery('<div>')
                    .addClass('flipbook-menuHolder')
                    .appendTo(this.wrapper)
                    .css('left', '0')
                    .css('top', this.menuTop.outerHeight() + 'px')
                    .hide()

                this.createMenuHeader(this.sideMenuHolder, this.strings.sideMenu, this.toggleSideMenu, false)

                this.sideMenu = jQuery('<div>')
                    .addClass('flipbook-side-menu')
                    .appendTo(this.sideMenuHolder)

                this.sideMenuScroller = jQuery('<div>')
                    .addClass('flipbook-side-menu-scroller')
                    .appendTo(this.sideMenu);

                sideMenuShare = jQuery('<a>')
                    .addClass('flipbook-side-menu-item flipbook-side-share')
                    .html('<span><i class="fas fa-share-alt"></i> Compartilhar</span>')
                    .bind('touchend click', function(e) {
                        e.stopPropagation();
                        e.preventDefault();
                        self.toggleShareMenu()
                    })
                    .appendTo(this.sideMenuScroller);
                
                jQuery('<div>')
                    .addClass('separador-menu')
                    .appendTo(this.sideMenuScroller);
                
                sideMenuDownload = jQuery('<a>')
                    .addClass('flipbook-side-menu-item flipbook-side-download')
                    .attr('id', "temp-download")
                    .attr('download', self.options.btnDownloadPdf.url.split('/').pop().split('#')[0].split('?')[0])
                    .attr('href', '../../download/pdf?url=' + self.options.btnDownloadPdf.url + '&name=' + self.options.btnDownloadPdf.url.split('/').pop().split('#')[0].split('?')[0])
                    .html('<span><i class="fas fa-download"></i> Baixar Catálogo</span>')
                    .bind('touchend click', function(e) {
                        toastr.options = {
                            "closeButton": true,
                            "debug": false,
                          ...
                          toastr["success"]("O download começará em breve!", "Aguarde...")
                    })
                    .appendTo(this.sideMenuScroller);
                ...
                sideMenuToc = jQuery('<a>')
                    .addClass('flipbook-side-menu-item flipbook-side-categorias')
                    .html('<span><i class="fas fa-list-ul"></i> Categoria de Produtos</span>')
                    .bind('touchend click', function(e) {
                        e.stopPropagation();
                        e.preventDefault();
                        self.toggleToc()
                ...
                sideMenuCookiesBtn = jQuery('<a>')
                    .addClass('flipbook-side-menu-item flipbook-side-item-cookies')
                    .html('<span><i class="fas fa-cookie-bite"></i> Política de Cookies</span>')
                    .bind('touchend click', function(e) {
                        e.stopPropagation();
                        e.preventDefault();
                        self.toggleCookies()
                ...
                $(document).on('click', function(event) {
                    ...
                    var clickInside = $target
                                .closest('.flipbook-menuHolder, .flipbook-cookiesHolder, .flipbook-cookies-configHolder, .popover-navigation')
                                .length
                    console.log($target)
                    if($target.id == "temp-download") return false;
                    if(!clickInside && (self.sideMenuShowing || self.liveChatShowing || self.cookiesShowing || self.cookiesConfigShowing)){
            ...
            createLiveChat: function(product=false) {

                var self = this;

                this.liveChatHolder = jQuery('<div>')
                    .addClass('flipbook-livechatHolder')
                    .appendTo(this.wrapper)
                    .css('left', '0')
                    .css('top', this.menuTop.outerHeight() + 'px')
                    .hide()

                this.createMenuHeader(this.liveChatHolder, this.strings.liveChatName, this.toggleLiveChat, false)

                this.sideLiveChat = jQuery('<div>')
                    .addClass('flipbook-side-livechat')
                    .appendTo(this.liveChatHolder)

                this.liveChatScroller = jQuery('<div>')
                    .addClass('flipbook-livechat-scroller')
                    .appendTo(this.sideLiveChat);

                this.liveChatCreated = true
                if (this.options.onchatcreated)
                    this.options.onchatcreated.call(this, product)

                if(!product){
                    this.toggleLiveChat()
                }
            },
            dragToCart: function(el){
                var self = this;
                var cart = self.btnCart;
                var selectedProduct = el.data("product");
                var product = $.map( self.options.cartProducts, function( a, index ) {
                    if(a.sku == selectedProduct){
                        return a;
                ...
                var img = product.img || "https://static.2bebot.com.br/img/sacola.svg"
                var imgtodrag = $('<div/>').html('<img src="' + img + '" alt="' + product["titulo"] + '" />').contents();

                if(el.hasClass("flipbook-jqt-cart-indicate"))
                    el.addClass("flipbook-jqt-cart-added");
            ...
            cartAdd: function(product, amount=1){
                
                var self = this,
                cart = self.btnCart,
                cartArray = self.options.cartItens;

                if(!product.complementos.length){
                    // Verifica se já foi adicionado
                    _adicionado = $.map( cartArray, function( a, index ) {
                        if(a){
                            if(a.sku == product["sku"]){
                                return index;
                            }
                        }                        
                    });
                    if(_adicionado.length > 0){
                        cartArray[_adicionado[0]]["amount"] += amount;
                    }else{
                        cartArray.push({
                            "sku": product["sku"],
                ...
                _total = cartArray.filter(Boolean).reduce((a, b) => +a + +(b.price * b.amount), 0);
                _diferenca = _saldo - _total;
                
                tooltipOptions = {
                    theme: 'TooltipDark',
                    title: product["sku"] + ' - ' + product["titulo"],
                    content: amount + 'x ' + new Intl.NumberFormat('pt-BR', {
                                                    style: 'currency', 
                                                    currency: 'BRL' 
                ...
                if(_saldo){
                    tooltipOptions["footer"] = "<b>Saldo Restante:</b> " + new Intl.NumberFormat('pt-BR', {
                                                    style: 'currency', 
                                                    currency: 'BRL' 
                                            }).format(_diferenca) + "<br><b>Preço Total:</b> " + new Intl.NumberFormat('pt-BR', {
                                                    style: 'currency', 
                                                    currency: 'BRL' 
                                            }).format(_total)
                }
                btnTooltip = cart.jBox('Tooltip', tooltipOptions).open();
                  setTimeout(function(){
                      btnTooltip.close();
                      btnTooltip.destroy();
                  }, 10000)
                if(_paq){
                    _paq.push(['addEcommerceItem',
                        product["sku"], // (Required) productSKU
                        product["titulo"], // (Optional) productName
                        [], // (Optional) productCategory
                        product["valor"], // (Recommended) price
                        amount // (Optional, defaults to 1) quantity
                    ]);
                    _paq.push(['trackEcommerceCartUpdate', self.options.cartTotal]); 
                }
                
                if(self.options.btnLiveChat.enabled && !self.liveChatCreated){
                    self.createLiveChat(product);
                }else{
                    if (self.options.oncartadded)
                        self.options.oncartadded.call(this, product)
                }
            },

            createModalFormulario: function(form) {

                var self = this;
                
                this.formularioHolder = jQuery('<div>')
                    .addClass('flipbook-complementoHolder')
                    .addClass('modal')
                    .appendTo('body')
                this.formularioScroller = jQuery('<div>')
                    .addClass('flipbook-complementos-scroller')
                    .appendTo(this.formularioHolder);

                this.modalFormularioCreated = true
                this.toggleModalFormulario(form)
                    
            },

            updateModalFormulario: function(form) {

                var self = this;
                
                formulario = $.map( self.options.cartForms, function( a, index ) {
                    if(a.id == form){
                        return a;
                    }
                });
                ...
                this.formularioScroller.html("");

                this.formularioTitulo = jQuery('<p>')
                    .html(formulario.title)
                    .addClass('flipbook-complementos-modal-titulo')
                    .appendTo(this.formularioScroller);

                $.each(formulario.campos, function (i, item) {
                    grupo = jQuery('<div>').appendTo(self.formularioScroller);
                    grupoTituloHolder = jQuery('<div>')
                                        .addClass('flipbook-grupo-titulo-holder')
                                        .appendTo(grupo);
                    grupoTitulo = jQuery('<span>')
                                    .addClass('flipbook-grupo-titulo')
                                    .text(item.titulo)
                                    .appendTo(grupoTituloHolder);

                    if(item.status == "1"){
                        grupoObrigatorio = jQuery('<span>')
                                    .addClass('flipbook-titulo-label')
                                    .text("Obrigatório")
                                    .appendTo(grupoTituloHolder);
                    }
                    grupoSelecao = jQuery('<div>')
                                    .addClass('flipbook-grupo-selecao')
                                    .appendTo(grupo);

                    if(item.tipo == "date"){
                        complementoOpcao = jQuery('<div>')
                                                .addClass('flipbook-complemento-opcao')
                                                .appendTo(grupoSelecao);
                        calendarDatePicker = jQuery('<div>')
                                                .appendTo(complementoOpcao);
                    ...
                    if(item.tipo == "horario24"){
                        complementoOpcao = jQuery('<div>')
                                                .addClass('flipbook-complemento-opcao')
                                                .appendTo(grupoSelecao);
                        timePicker = jQuery('<input>')
                                        .attr('type', 'text')
                                        .attr('name', 'timepicker')
                                        .addClass('time_element')
                                        .addClass('modal-form-control')
                                        .appendTo(complementoOpcao);
                    ...
                    if(item.tipo == "text"){
                        complementoOpcao = jQuery('<div>')
                                                .addClass('flipbook-complemento-opcao')
                                                .appendTo(grupoSelecao);
                        complementoInput = jQuery('<input>')
                            .attr('type', 'text')
                            .attr('maxlength', item.max)
                            .addClass('modal-form-control')
                            .appendTo(complementoOpcao);
                        complementoCaracteresWrapper = jQuery('<span>')
                            .addClass('text-muted')
                            .addClass('form-text')
                            .appendTo(complementoOpcao);
                        complementoCaracteres = jQuery('<span>')
                            .html('0')
                            .appendTo(complementoCaracteresWrapper);
                        complementoCaracteresTotal = jQuery('<span>')
                            .html('/' + item.max + ' caracteres')
                            .appendTo(complementoCaracteresWrapper);

                        complementoInput.on('change keydown keypress keyup mousedown click mouseup input', function() { 
                            complementoCaracteres.html($(this).val().length);
                        });
                    }
                    ...
                    if(item.tipo == "cep"){
                        ...
                        complementoInput.mask('00000-000');
                    }
                    ...
                    if(item.tipo == "cpf"){
                        ...
                        complementoInput.mask('000.000.000-00', {reverse: true});
                    }

                    if(item.tipo == "ddmmaaaa"){
                        complementoOpcao = jQuery('<div>')
                                                .addClass('flipbook-complemento-opcao')
                                                .appendTo(grupoSelecao);
                        complementoInput = jQuery('<input>')
                        ...
                        complementoInput.mask('00/00/0000');
                    }
                    ...
                    if(item.tipo == "select"){
                        complementoOpcao = jQuery('<div>')
                                                .addClass('flipbook-complemento-opcao')
                                                .appendTo(grupoSelecao);
                        complementoSelect = jQuery('<select>')
                            .attr('type', 'text')
                            .addClass('modal-form-control')
                            .appendTo(complementoOpcao);
                        $.each(item.opcoes, function (_i, _opcao) {
                            jQuery('<option>')
                                .attr('value', _opcao.value)
                                .html(_opcao.title)
                                .appendTo(complementoSelect);
                        });
                    }
                    ...
                    if(item.tipo == "telefone"){
                        ...
                        TelefoneMaskBehavior = function (val) {
                            return val.replace(/\D/g, '').length === 11 ? '(00) 00000-0000' : '(00) 0000-00009';
                        };
                            
                        complementoInput.mask(TelefoneMaskBehavior, {
                    ...
                    if(item.tipo == "textarea"){
                        complementoOpcao = jQuery('<div>')
                                                .addClass('flipbook-complemento-opcao')
                                                .appendTo(grupoSelecao);
                        complementoTextarea = jQuery('<textarea>')
                            .attr('rows', '3')
                            .attr('maxlength', item.max)
                            .addClass('modal-form-control')
                            .appendTo(complementoOpcao);
                        ...
                        complementoCaracteresWrapper = jQuery('<span>')
                            ...
                            .addClass('form-text')
                            .appendTo(complementoOpcao);
                        complementoCaracteresTextarea = jQuery('<span>')
                            .html('0')
                            .appendTo(complementoCaracteresWrapper);
                        complementoCaracteresTotal = jQuery('<span>')
                            .html('/' + item.max + ' caracteres')
                        ...
                        complementoTextarea.on('change keydown keypress keyup mousedown click mouseup input', function() { 
                            complementoCaracteresTextarea.html($(this).val().length);
                        }); 
                    }
                    
                });
                this.formAdicionar = jQuery('<div>')
                                            .addClass('flipbook-complementos-adicionar')
                                            .appendTo(this.formularioScroller);
                this.formAdicionarBtn = jQuery('<a>')
                                                .attr('href', '#')
                                                .addClass('flipbook-complementos-adicionar-btn')
                                                .appendTo(this.formAdicionar);
                                                
                this.formAdicionarTxt = jQuery('<span>')
                                                .html(formulario.btnEnviar)
                                                .appendTo(this.formAdicionarBtn);            
                this.formAdicionarBtn.on("click", function (event) {
                    event.preventDefault();
                    $.modal.close();
                    toastr.options = {
                        "closeButton": true,
                    ...
                    toastr["success"](formulario.msgEnviado)
                })   
                
                    
            },

            createModalComplemento: function(produto, el) {

                var self = this;

                if(!this.modalComplementoCreated){
                    this.complementoHolder = jQuery('<div>')
                        .addClass('flipbook-complementoHolder')
                        .addClass('modal')
                        .appendTo('body')
                    this.complementosScroller = jQuery('<div>')
                        .addClass('flipbook-complementos-scroller')
                        .appendTo(this.complementoHolder);
                    this.modalComplementoCreated = true
                }else{
                    this.complementosScroller.html("");
                }
                
                this.complementoTitulo = jQuery('<p>')
                    .html(produto.titulo)
                    .addClass('flipbook-complementos-modal-titulo')
                    .appendTo(this.complementosScroller);
                    
                $.each(produto.complementos, function (i, item) {
                    grupo = jQuery('<div>').appendTo(self.complementosScroller);
                    grupoTituloHolder = jQuery('<div>')
                                        .addClass('flipbook-grupo-titulo-holder')
                                        .appendTo(grupo);
                    grupoTitulo = jQuery('<span>')
                    ...
                    grupoSelecao = jQuery('<div>')
                                    ...
                                    .appendTo(grupo);
                    console.log(item)
                    $.each(item.opcoes, function (_i, produtoOpcao) {
                        if(produtoOpcao.status == "1"){
                            complementoOpcao = jQuery('<div>')
                                                .addClass('flipbook-complemento-opcao')
                                                .appendTo(grupoSelecao);

                            if(item.max == 1){
                                opcaoRadio = jQuery('<input>')
                                                .attr('type', 'radio')
                                                .attr('name', i)
                                                .attr('value', _i)
                                                .appendTo(complementoOpcao);
                                opcaoRadio.on("click", function (event) {
                                    if(produtoOpcao.valor){
                                        self.updateComplemento(produto);
                                    }
                                })
                            }else{
                                itemInputHolder = jQuery(document.createElement('div'))
                            ...
                            opcaoSelecionar = jQuery('<label>')
                                                .html(produtoOpcao.titulo)
                                                .appendTo(complementoOpcao);
                            opcaoValor = jQuery('<label>')
                                            .html(new Intl.NumberFormat('pt-BR', {
                                                    style: 'currency', 
                                                    currency: 'BRL' 
                                            }).format(produtoOpcao.valor))
                                            .css('float', 'right')
                                            .appendTo(complementoOpcao);
                        }
                    });
                });
                this.complementoAdicionar = jQuery('<div>')
                                            .addClass('flipbook-complementos-adicionar')
                                            .appendTo(this.complementosScroller);
                this.complementoAdicionarBtn = jQuery('<a>')
                                                .attr('href', '#')
                                                .attr('data-produto', produto.sku)
                                                .addClass('flipbook-complementos-adicionar-btn')
                                                .appendTo(this.complementoAdicionar);
                this.complementoAdicionarIcn = jQuery('<i>')
                                                .css('margin-right', '10px')
                                                .addClass('fas fa-shopping-cart')
                                                .appendTo(this.complementoAdicionarBtn);
                this.complementoAdicionarTxt = jQuery('<span>')
                                                .text('Adicionar ao pedido - ')
                                                .appendTo(this.complementoAdicionarBtn);
                this.complementoAdicionarTotal = jQuery('<span>')
                                                .html(new Intl.NumberFormat('pt-BR', {
                                                        style: 'currency', 
                                                        currency: 'BRL' 
                                                }).format(produto.valor))
                                                .attr('data-valor', produto.valor)
                                                .appendTo(this.complementoAdicionarBtn);
                        
                this.complementoAdicionarBtn.on("click", function (event) {
                    event.preventDefault();
                    resultado = self.updateComplemento(produto);
                    console.log(resultado);
                    if(resultado.valido){
                        $.modal.close();
                        self.dragToCart(el);
                        self.cartAdd({
                            "complementos": resultado.complementos,
                            "price": resultado.total,
                        ...
                        alert("Preencha todos os complementos obrigatórios para adicionar.")
                    }
                    
                })

                this.complementoHolder.modal({
                    escapeClose: true,
                    clickClose: true,
                    showClose: true
                });
            ...
            createModalSaldoDisponivel: function() {
                ...
                this.saldoDisponivelHolder = jQuery('<div>')
                    .addClass('flipbook-saldo-disponivelHolder')
                    .addClass('modal')
                ...
                this.saldoDisponivelTitulo = jQuery('<p>')
                    .html(`Você ainda possui saldo de ` + new Intl.NumberFormat('pt-BR', {
                                style: 'currency', 
                                currency: 'BRL' 
                        }).format(_diferenca))
                    .css('font-size', '1.1rem')
                    .appendTo(this.saldoDisponivelHolder);

                jQuery('<p>')
                    .html(`Deseja finalizar o resgate mesmo assim?`)
                    .css('margin-bottom', '8px')
                    .appendTo(this.saldoDisponivelHolder);
                
                jQuery('<p>')
                    .html(`O saldo restante não poderá ser mais utilizado após a compra.`)
                    .css('margin-top', '0')
                    .appendTo(this.saldoDisponivelHolder);

                jQuery('<a>')
                    .attr('href', '#')
                    .html(`Finalizar Resgate`)
                    .addClass('flipbook-btn-finalizar-modal')
                    .appendTo(this.saldoDisponivelHolder);

                jQuery('<a>')
                    .attr('href', '#close-modal')
                    .attr('rel', 'modal:close')
                    .html(`Voltar para o catálogo`)
                    .addClass('flipbook-btn-voltar-modal')
                    .appendTo(this.saldoDisponivelHolder);

                this.modalSaldoDisponivelCreated = true
                this.toggleModalSaldoDisponivel()

            },

            createModalSaldoIndisponivel: function() {
                ...
                this.saldoIndisponivelHolder = jQuery('<div>')
                    .addClass('flipbook-saldo-disponivelHolder')
                    .addClass('modal')
                    .css('text-align', 'center')
                    .css('font-family', 'sans-serif')
                ...
                this.saldoIndisponivelTitulo = jQuery('<p>')
                    .html(`Saldo Insuficiente!`)
                    .css('font-size', '1.1rem')
                    .appendTo(this.saldoIndisponivelHolder);

                jQuery('<p>')
                    .html(`O saldo de seu carnê é insuficiente para finalizar o resgate.`)
                    .css('margin-bottom', '8px')
                    .appendTo(this.saldoIndisponivelHolder);
                
                jQuery('<p>')
                    .html(`Clique abaixo para saber mais sobre como pagar o valor excedente na 13º parcela ou remova itens do carrinho.`)
                    .css('margin-top', '0')
                    .appendTo(this.saldoIndisponivelHolder);

                jQuery('<a>')
                    .attr('href', '#')
                    .html(`Pagar 13º Parcela`)
                    .addClass('flipbook-btn-finalizar-modal')
                    .appendTo(this.saldoIndisponivelHolder);
                ...
                this.modalSaldoIndisponivelCreated = true
                this.toggleModalSaldoIndisponivel()

            },

            createModalIndisponivel: function() {

                var self = this;

                this.indisponivelHolder = jQuery('<div>')
                    .addClass('flipbook-indisponivelHolder')
                    .addClass('modal')
                    .appendTo('body')
                

                this.indisponivelTitulo = jQuery('<p>')
                    .html(`Produto Indisponível!`)
                    .css('text-align', 'center')
                    .css('font-size', '1.5rem')
                    .css('font-family', 'sans-serif')
                    .appendTo(this.indisponivelHolder);

                this.modalIndisponivelCreated = true
                this.toggleModalIndisponivel()

            },

            createModalCalendar: function(date, hour, title) {

                var self = this;

                this.calendarHolder = jQuery('<div>')
                    .addClass('flipbook-calendarHolder')
                    .addClass('modal')
                    .appendTo('body')
                

                this.calendarTitulo = jQuery('<p>')
                    .css('text-align', 'center')
                    .css('font-size', '1.5rem')
                    .css('font-family', 'sans-serif')
                    .appendTo(this.calendarHolder);

                this.calendarDateHolder = jQuery('<div>')
                    .html("Selecione um dia:")
                    .css('font-family', 'sans-serif')
                    .css('text-align', 'center')
                    .appendTo(this.calendarHolder);
                this.calendarDatePicker = jQuery('<div>')
                    .appendTo(this.calendarDateHolder);
                ...
                /*this.calendarTimeHolder = jQuery('<div>')
                    .html("Selecione um horário:")
                    .css('font-family', 'sans-serif')
                    .appendTo(this.calendarHolder);
                this.calendarTimePicker = jQuery('<div>')
                    .datetimepicker({
                        inline: true,
                        format: 'LT',
                        stepping: 30,
                    ...
                    .appendTo(this.calendarTimeHolder);*/

                this.modalCalendarCreated = true
                this.toggleModalCalendar(date, hour, title)

            },

            createModalCheckoutChatbot: function() {

                var self = this,
                chatbotID = this.options.cartCheckout;

                if (!FLIPBOOK.scriptsAdded[FLIPBOOK.landbotSrc]) {
                    self.loadScript(FLIPBOOK.landbotSrc, function() {
                        self.createModalCheckoutChatbot()
                    })
                    return;
                }

                this.checkoutChatbotHolder = jQuery('<div>')
                    .addClass('flipbook-checkout-chatbotHolder')
                    .addClass('modal')
                    .appendTo('body')

                this.checkoutChatbotTitulo = jQuery('<p>')
                    .html(`Finalizar Pedido`)
                    .css('text-align', 'center')
                    .css('font-size', '1.4rem')
                    .css('margin', '10px')
                    .css('font-family', 'sans-serif')
                    .appendTo(this.checkoutChatbotHolder);

                this.checkoutChatbotWrapper = jQuery('<div>')
                    .addClass('flipbook-checkout-chatbot-wrapper')
                    .appendTo(this.checkoutChatbotHolder);

                _customData = self.options.chatData
                _customData["session"] = self.options.ws.id.split("#")[1]
                this.chatbotCheckoutContainer = new Landbot.Container({
                    container: '.flipbook-checkout-chatbot-wrapper',
                    configUrl: 'https://chats.landbot.io/v3/' + chatbotID + '/index.json',
                    customData: _customData
                });
                    

                this.modalCheckoutChatbotCreated = true
                this.toggleModalCheckoutChatbot()
            ...
            createCookies: function() {
                ...
                this.cookiesHolder = jQuery('<div>')
                    .addClass('flipbook-cookiesHolder')
                    .appendTo(this.wrapper)
                    .css('left', '0')
                    .css('top', this.menuTop.outerHeight() + 'px')
                    .hide()

                this.createMenuHeader(this.cookiesHolder, this.strings.cookies, this.toggleCookies, false)

                this.sideCookies = jQuery('<div>')
                    .addClass('flipbook-side-cookies')
                    .appendTo(this.cookiesHolder)

                this.cookiesScroller = jQuery('<div>')
                    .addClass('flipbook-cookies-scroller')
                    .appendTo(this.sideCookies);

                
                

                cookiesPolicy = jQuery('<p>')
                .html(`O Baú da Felicidade | Jequiti enquanto parte do Grupo Silvio Santos (GSS), está empenhado em proteger a privacidade de seu dados pessoais. Portanto todas as empresas do grupo estão adotando as medidas necessárias para atender à nova lei (LGPD).<br>
                Ao clicar em ACEITAR TUDO, você concorda em armazenar cookies no seu dispositivo para proporcionar a melhor experiência de navegação para você.<br>
                Nas configurações você pode alterar os cookies definidos ou atualizar suas preferências.
                `)
                .appendTo(this.cookiesScroller);

                this.cookiesFooter = jQuery('<div>')
                    .addClass('flipbook-cookies-footer')
                    .appendTo(this.sideCookies);
                
                this.cookiesAcceptButton = jQuery('<div>')
                    .addClass('flipbook-cookies-button')
                    .addClass('flipbook-cookies-accept')
                    .text('ACEITAR TUDO')
                    .bind('touchend click', function(e) {
                        e.stopPropagation();
                        e.preventDefault();
                    ...
                    .appendTo(this.cookiesFooter);
                
                this.cookiesConfigButton = jQuery('<div>')
                    .addClass('flipbook-cookies-button')
                    .text('CONFIGURAÇÕES')
                    .bind('touchend click', function(e) {
                        e.stopPropagation();
                        e.preventDefault();
                        self.toggleCookiesConfig()
                    })
                    .appendTo(this.cookiesFooter);
            ...
            createCookiesConfig: function() {

                var self = this;

                this.cookiesConfigHolder = jQuery('<div>')
                    .addClass('flipbook-cookies-configHolder')
                    .appendTo(this.wrapper)
                    .css('left', '0')
                    .css('top', this.menuTop.outerHeight() + 'px')
                    .hide()

                this.createMenuHeader(this.cookiesConfigHolder, this.strings.cookiesConfig, this.toggleCookiesConfig, false)

                this.sideCookiesConfig = jQuery('<div>')
                    .addClass('flipbook-side-cookies-config')
                    .appendTo(this.cookiesConfigHolder)

                this.cookiesConfigScroller = jQuery('<form>')
                    .addClass('flipbook-cookies-config-scroller')
                    .appendTo(this.sideCookiesConfig);

                cookies1 = jQuery('<label>')
                    .addClass('checkbox')
                    .html(`
                        <input type="radio" checked="checked" name="cookies1"/>
                        <span></span>
                        <b>Estritamente necessário: </b> Os cookies são essenciais para ativar funcionalidades básicas, como navegação, conceder acesso ao conteúdo protegido e salvar o conteúdo do seu carrinho de compras durante a sua permanência no site.
                    `)
                    .appendTo(this.cookiesConfigScroller);
                
                cookies2 = jQuery('<label>')
                    .addClass('checkbox')
                    .html(`
                        <input type="radio" name="cookies2"/>
                        <span></span>
                        <b>Desempenho: </b> Os cookies nos permitem contar as visitas e origens de tráfego ao site, além de entender como ele é usado. Isso serve para melhorar o desempenho. Toda a informação é agregada e, portanto, anônima.
                    `)
                    .appendTo(this.cookiesConfigScroller);

                cookies3 = jQuery('<label>')
                    .addClass('checkbox')
                    .html(`
                        <input type="radio" name="cookies3"/>
                        <span></span>
                        <b>Funcionalidade: </b> Os cookies permitem que o site ofereça funções aprimoradas e opções pessoais. Por exemplo, opções de tamanho de fonte etc.
                    `)
                    .appendTo(this.cookiesConfigScroller);

                cookies4 = jQuery('<label>')
                    .addClass('checkbox')
                    .html(`
                        <input type="radio" name="cookies4"/>
                        <span></span>
                        <b>Anúncios: </b> Os cookies são usados para oferecer anúncios mais relevantes para você e seus interesses. Eles não armazenam informações pessoais, mas se baseiam no histórico do navegador.
                    `)
                    .appendTo(this.cookiesConfigScroller);

                this.cookiesConfigFooter = jQuery('<div>')
                    .addClass('flipbook-cookies-footer')
                    .appendTo(this.sideCookies);
                
                this.cookiesConfigAcceptButton = jQuery('<div>')
                    .addClass('flipbook-cookies-button')
                    .addClass('flipbook-cookies-accept')
                    .text('Aceitar selecionadas')
                    .bind('touchend click', function(e) {
                        e.stopPropagation();
                        e.preventDefault();
                        self.closeMenus()
                ...
                this.cookiesConfigCreated = true
                this.toggleCookiesConfig()
            ...
            resize: function() {
                ...
                if(this.tocShowing || this.cartShowing || this.sideMenuShowing || this.cookiesConfigShowing || this.liveChatShowing || this.cookiesShowing || this.thumbsShowing || this.searchShowing || this.bookmarkShowing){
            ...
            toggleCart: function(value) {
                ...
                if (!this.cartShowing || value) {

                    this.closeMenus()
                    this.updateCart()
                    this.cartShowing = true
                    this.bookLayer.css("right", "24rem");
                    this.cartHolder.show()

                } else {

                    this.bookLayer.css("right", 0);
                    this.cartHolder.hide()
                    this.cartShowing = false
            ...
            toggleSideMenu: function(value) {
                ...
                if (!this.sideMenuShowing || value) {

                    this.closeMenus()
                    this.sideMenuShowing = true
                    this.sideMenuHolder.show("slide", { direction: "left" }, 800);

                } else {
                    
                    this.sideMenuHolder.hide("slide", { direction: "left" }, 800)
                    this.sideMenuShowing = false
            ...
            toggleModalCheckoutChatbot: function() {

                if (!this.modalCheckoutChatbotCreated) {

                    this.createModalCheckoutChatbot()
                    return
                
                }

                if (!this.modalCheckoutChatbotShowing || !$.modal.isActive()) {

                    this.closeMenus()
                    this.modalCheckoutChatbotShowing = true
                    this.checkoutChatbotHolder.modal({
                            escapeClose: false,
                            clickClose: false,
                            showClose: false
                        });
            ...
            toggleModalCalendar: function(date, hour, title) {

                if (!this.modalCalendarCreated) {

                    this.createModalCalendar(date, hour, title)
                    return
                
                }

                if (!this.modalCalendarShowing || !$.modal.isActive()) {

                    this.closeMenus()
                    this.modalCalendarShowing = true
                    this.calendarTitulo.html(title)
                    this.calendarHolder.modal({
                            escapeClose: true,
                            clickClose: true,
                            showClose: true
                        });
            ...
            toggleModalFormulario: function(form) {

                if (!this.modalFormularioCreated) {

                    this.createModalFormulario(form)
                    return
                
                }

                if (!this.modalFormularioShowing || !$.modal.isActive()) {
                    
                    this.modalFormularioShowing = true
                    this.updateModalFormulario(form);
                    this.formularioHolder.modal({
                            escapeClose: true,
                            clickClose: true,
                            showClose: true
                        });
            ...
            toggleModalIndisponivel: function() {

                if (!this.modalIndisponivelCreated) {

                    this.createModalIndisponivel()
                    return
                
                }

                if (!this.modalIndisponivelShowing || !$.modal.isActive()) {

                    this.closeMenus()
                    this.modalIndisponivelShowing = true
                    this.indisponivelHolder.modal({
                            escapeClose: true,
                            clickClose: true,
                            showClose: true
                        });
            ...
            toggleModalSaldoDisponivel: function() {
                var self = this;
                _total = self.options.cartTotal;
                _saldo = self.options.cartCredits;
                _diferenca = _saldo - _total;

                if (!this.modalSaldoDisponivelCreated) {

                    this.createModalSaldoDisponivel()
                    return
                
                }

                if (!this.modalSaldoDisponivelShowing || !$.modal.isActive()) {

                    this.closeMenus()
                    self.saldoDisponivelTitulo.html(`Você ainda possui saldo de ` + new Intl.NumberFormat('pt-BR', {
                            style: 'currency', 
                            currency: 'BRL' 
                    }).format(_diferenca));
                    this.modalSaldoDisponivelShowing = true
                    this.saldoDisponivelHolder.modal({
                            escapeClose: true,
                            clickClose: true,
                            showClose: true
                        });
            ...
            toggleModalSaldoIndisponivel: function() {

                if (!this.modalSaldoIndisponivelCreated) {

                    this.createModalSaldoIndisponivel()
                    return
                
                }

                if (!this.modalSaldoIndisponivelShowing || !$.modal.isActive()) {

                    this.closeMenus()
                    this.modalSaldoIndisponivelShowing = true
                    this.saldoIndisponivelHolder.modal({
                            escapeClose: true,
                            clickClose: true,
                            showClose: true
                        });
            ...
            toggleCookies: function(value) {
                ...
                if (!this.cookiesShowing || value) {

                    this.closeMenus()
                    this.cookiesShowing = true
                    this.cookiesHolder.show();

                } else {
                    
                    this.cookiesHolder.hide()
                    this.cookiesShowing = false
            ...
            toggleLiveChat: function(value) {
                var o = this.options;
                if (!this.liveChatCreated) {
                ...
                if (!this.liveChatShowing || value) {

                    this.closeMenus()
                    this.liveChatShowing = true
                    this.liveChatHolder.show();

                } else {
                    
                    this.liveChatHolder.hide()
                    this.liveChatShowing = false
            ...
            toggleCookiesConfig: function(value) {

                if (!this.cookiesConfigCreated) {

                    this.createCookiesConfig()
                    return
                
                }

                if (!this.cookiesConfigShowing || value) {

                    this.closeMenus()
                    this.cookiesConfigShowing = true
                    this.cookiesConfigHolder.show();

                } else {
                    
                    this.cookiesConfigHolder.hide()
                    this.cookiesConfigShowing = false
            ...
            closeMenus: function() {
                ...
                if (this.cartShowing) this.toggleCart()
                if (this.sideMenuShowing) this.toggleSideMenu()
                if (this.cookiesShowing) this.toggleCookies()
                if (this.cookiesConfigShowing) this.toggleCookiesConfig()
                if (this.searchShowing) this.toggleSearch()
                if (this.liveChatShowing) this.toggleLiveChat()
            ...
            toggleShareMenu: function() {
                ...
                if (!this.shareMenu) {
                    ...
                    var center = jQuery('<div class="flipbook-sub-menu-center">').appendTo(this.shareMenu)
                    var content = jQuery('<div class="flipbook-sub-menu-content flipbook-sub-menu-share skin-color-bg">').appendTo(center)

                    this.createMenuHeader(content, this.options.strings.share, this.toggleShareMenu)

                    var shareBtn = jQuery('<div class="flipbook-share">').appendTo(content)
                    ...
                    var shareUrl = jQuery('<div class="flipbook-share">').appendTo(content)
                    var shareUrlInput = jQuery('<input id="copiar-url" value="' + window.location.href + '"><button class="btn btn-copiar" data-clipboard-target="#copiar-url"><i class="fas fa-copy"></i> Copiar</button>').appendTo(shareUrl)
            ...
            togglePrintWindow: function(value) {
                ...
                if (!this.printWindowCreated) {
                    ...
                    var html = jQuery('<div class="panel panel-default">' +
                        ...
                        '<select multiple class="modal-form-control">' +
...
//                 }
...

        {
            ...
            FLIPBOOK.landbotSrc = "https://static.landbot.io/landbot-3/landbot-3.0.0.js"
            FLIPBOOK.dateTimePickerLocaleSrc = "https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/locales/bootstrap-datepicker.pt-BR.min.js"
            FLIPBOOK.dateTimePickerSrc = "https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/js/bootstrap-datepicker.min.js"
            FLIPBOOK.momentSrc = "https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.1/moment.min.js"
            FLIPBOOK.bootstrapSrc= "https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"
            FLIPBOOK.momentLocaleSrc = "https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.1/locale/pt-br.min.js"
            FLIPBOOK.socketIOSrc = "//cdnjs.cloudflare.com/ajax/libs/socket.io/2.2.0/socket.io.js"
            FLIPBOOK.jQueryModalSrc = "https://cdnjs.cloudflare.com/ajax/libs/jquery-modal/0.9.1/jquery.modal.min.js"
            FLIPBOOK.jQueryInputMask = "https://static.2bebot.com.br/js/componentes/mask/jquery.mask.js"
            FLIPBOOK.TimePickiSrc = "https://static.2bebot.com.br/componentes/TimePicki/timepicki.js"
...
//share
{
    ! function(t) {
        ...
        return e = function(t) {
            ...
            return o(e, t), e.prototype.setup = function(t, e) {
            ...
            }, e.prototype.network_whatsapp = function() {
                return this.popup("https://www.whatsapp.com/", {
                    url: this.config.networks.whatsapp.url,
                    media: this.config.networks.whatsapp.image,
                    description: this.config.networks.whatsapp.description
                })
            }, e.prototype.network_download = function() {
                return window.open(this.config.networks.download.url, "_blank");
                ...
                return t.innerHTML = "<div class='social load " + this.config.ui.flyout + "'><ul><li id='flipbook-share-whatsapp' data-network='whatsapp'><i class='fab fa-whatsapp skin-color'></i></li><li id='flipbook-share-twitter' data-network='twitter'><i class='fab fa-twitter skin-color'></i></li><li id='flipbook-share-facebook' data-network='facebook'><i class='fab fa-facebook-f skin-color'></i></li><li id='flipbook-share-download' data-network='download'><i class='fas fa-download skin-color'></i></li><li id='flipbook-share-email' data-network='email'><i class='fas fa-envelope skin-color'></i></li></ul></div>"
