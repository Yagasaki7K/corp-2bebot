<template>
  <div class="q-pa-xl">
    <h4 class="q-ma-none q-mb-lg">Novo Fábrica</h4>
    <div>
      <div class="row justify-evenly q-mb-lg">
        <div class="col col-xs-12 col-md-5">
          ...
          <div class="q-mb-lg">
            ...
            <q-input v-model="admin.name" dense />
          </div>
          <div class="q-mb-lg">
            <label>Email:</label>
            <q-input v-model="admin.email" dense />
          </div>
          <div class="q-mb-lg">
            <label>CPF:</label>
            <q-input v-model="admin.cpf" dense />
          </div>
          <div class="q-mb-lg">
            <label>Telefone celular:</label>
            <q-input v-model="admin.phone" dense />
          </div>
        </div>
        <div class="col col-xs-12 col-md-5">
