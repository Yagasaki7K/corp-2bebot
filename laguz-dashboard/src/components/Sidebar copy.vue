<template>
  <div class="sidebar-fixed position-fixed">
    ...
    <mdb-list-group>
      <div v-if="role.name == 'corporate' || role.name == 'analytics'">
      ...
      <div v-if="role.name == 'corporate' || role.name == 'analytics'">
        <router-link to="/distributors" @click.native="activeItem = 2">
          <mdb-list-group-item
            :action="true"
            class="bg-color text-center p-2 mb-4"
      ...
      <div v-if="role.name == 'corporate' || role.name == 'analytics'">
        <router-link to="/campaign" @click.native="activeItem = 4">
          <mdb-list-group-item
            :action="true"
            class="bg-color text-center p-2 mb-4"
      ...
      <div v-if="role.name == 'corporate' || role.name == 'analytics'">
        <router-link to="/dumpingcsv" @click.native="activeItem = 6">
          <mdb-list-group-item
            :action="true"
            class="bg-color text-center p-2 mb-4"
